...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Strut Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class StrutTypeImpl extends ComplexBaseTypeImpl implements StrutType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getStrutType();
	}
	...
	public NotificationChain basicSetLength(DoubleBaseType newLength, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.STRUT_TYPE__LENGTH, oldLength, newLength);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLength != length) {
			...
			if (length != null)
				msgs = ((InternalEObject) length).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.STRUT_TYPE__LENGTH, null, msgs);
			if (newLength != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRUT_TYPE__LENGTH, newLength,
					newLength));
	}
