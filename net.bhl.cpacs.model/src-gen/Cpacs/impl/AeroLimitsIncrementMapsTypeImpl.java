 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getControlDeviceUID <em>Control Device UID</em>}</li>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getControlParameters <em>Control Parameters</em>}</li>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getControlDistributorUID <em>Control Distributor UID</em>}</li>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getCommandInputs <em>Command Inputs</em>}</li>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getAeroPerformanceIncrementMapUID <em>Aero Performance Increment Map UID</em>}</li>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getOperationLimitIncrements <em>Operation Limit Increments</em>}</li>
 *   <li>{@link Cpacs.impl.AeroLimitsIncrementMapsTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AeroLimitsIncrementMapsTypeImpl extends ComplexBaseTypeImpl implements AeroLimitsIncrementMapsType {
	...
	public NotificationChain basicSetControlDeviceUID(StringUIDBaseType newControlDeviceUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DEVICE_UID, oldControlDeviceUID,
					newControlDeviceUID);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newControlDeviceUID != controlDeviceUID) {
			...
			if (controlDeviceUID != null)
				msgs = ((InternalEObject) controlDeviceUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DEVICE_UID, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DEVICE_UID, newControlDeviceUID,
					newControlDeviceUID));
	}
	...
	public NotificationChain basicSetControlParameters(StringVectorBaseType newControlParameters,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_PARAMETERS, oldControlParameters,
		...
		if (newControlParameters != controlParameters) {
			...
			if (controlParameters != null)
				msgs = ((InternalEObject) controlParameters).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_PARAMETERS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_PARAMETERS, newControlParameters,
					newControlParameters));
	}
	...
	public NotificationChain basicSetControlDistributorUID(StringUIDBaseType newControlDistributorUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DISTRIBUTOR_UID, oldControlDistributorUID,
		...
		if (newControlDistributorUID != controlDistributorUID) {
			...
			if (controlDistributorUID != null)
				msgs = ((InternalEObject) controlDistributorUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DISTRIBUTOR_UID,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DISTRIBUTOR_UID, newControlDistributorUID,
					newControlDistributorUID));
	}
	...
	public NotificationChain basicSetCommandInputs(StringVectorBaseType newCommandInputs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__COMMAND_INPUTS, oldCommandInputs, newCommandInputs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCommandInputs != commandInputs) {
			...
			if (commandInputs != null)
				msgs = ((InternalEObject) commandInputs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__COMMAND_INPUTS, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__COMMAND_INPUTS, newCommandInputs, newCommandInputs));
	}
	...
	public NotificationChain basicSetAeroPerformanceIncrementMapUID(StringUIDBaseType newAeroPerformanceIncrementMapUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__AERO_PERFORMANCE_INCREMENT_MAP_UID,
	...
	public NotificationChain basicSetOperationLimitIncrements(OperationLimitIncrementsType newOperationLimitIncrements,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__OPERATION_LIMIT_INCREMENTS,
		...
		if (newOperationLimitIncrements != operationLimitIncrements) {
			...
			if (operationLimitIncrements != null)
				msgs = ((InternalEObject) operationLimitIncrements).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__OPERATION_LIMIT_INCREMENTS, null, msgs);
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__UID,
					oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DEVICE_UID:
			return basicSetControlDeviceUID(null, msgs);
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_PARAMETERS:
			return basicSetControlParameters(null, msgs);
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__CONTROL_DISTRIBUTOR_UID:
			return basicSetControlDistributorUID(null, msgs);
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__COMMAND_INPUTS:
			return basicSetCommandInputs(null, msgs);
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__AERO_PERFORMANCE_INCREMENT_MAP_UID:
			return basicSetAeroPerformanceIncrementMapUID(null, msgs);
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__OPERATION_LIMIT_INCREMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.AERO_LIMITS_INCREMENT_MAPS_TYPE__UID:
			return getUID();
		}
