...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cost Fuselages Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.CostFuselagesTypeImpl#getCostDescription <em>Cost Description</em>}</li>
 *   <li>{@link Cpacs.impl.CostFuselagesTypeImpl#getFuselage <em>Fuselage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CostFuselagesTypeImpl extends ComplexBaseTypeImpl implements CostFuselagesType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<GenericCostType> fuselage;
	 ...
	 * @generated
	 */
	protected CostFuselagesTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getCostFuselagesType();
	}
	...
	public NotificationChain basicSetCostDescription(GenericCostType newCostDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.COST_FUSELAGES_TYPE__COST_DESCRIPTION, oldCostDescription, newCostDescription);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCostDescription != costDescription) {
			...
			if (costDescription != null)
				msgs = ((InternalEObject) costDescription).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.COST_FUSELAGES_TYPE__COST_DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.COST_FUSELAGES_TYPE__COST_DESCRIPTION,
	 ...
	 */
	@Override
	public EList<GenericCostType> getFuselage() {
		if (fuselage == null) {
			fuselage = new EObjectContainmentEList<GenericCostType>(GenericCostType.class, this,
					CpacsPackage.COST_FUSELAGES_TYPE__FUSELAGE);
		}
		return fuselage;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.COST_FUSELAGES_TYPE__COST_DESCRIPTION:
			return basicSetCostDescription(null, msgs);
		case CpacsPackage.COST_FUSELAGES_TYPE__FUSELAGE:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CpacsPackage.COST_FUSELAGES_TYPE__FUSELAGE:
			getFuselage().clear();
			getFuselage().addAll((Collection<? extends GenericCostType>) newValue);
			return;
		}
