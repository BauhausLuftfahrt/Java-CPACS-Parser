...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Landing Gear Interface Lateral Panels Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getTransitionFrameUID <em>Transition Frame UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getFwdLatPanelLowY <em>Fwd Lat Panel Low Y</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getFwdLatPanelSheetUID <em>Fwd Lat Panel Sheet UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getFwdLatPanelReinforcementUID <em>Fwd Lat Panel Reinforcement UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getRearLatPanelHeightStringerUID <em>Rear Lat Panel Height Stringer UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getRearLatPanelSheetUID <em>Rear Lat Panel Sheet UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getRearLatPanelReinforcementUID <em>Rear Lat Panel Reinforcement UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceLateralPanelsTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LandingGearInterfaceLateralPanelsTypeImpl extends ComplexBaseTypeImpl
		implements LandingGearInterfaceLateralPanelsType {
	/**
	 ...
	 * @generated
	 */
	protected LandingGearInterfaceLateralPanelsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getLandingGearInterfaceLateralPanelsType();
	}
	...
	public NotificationChain basicSetTransitionFrameUID(StringUIDBaseType newTransitionFrameUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__TRANSITION_FRAME_UID,
					oldTransitionFrameUID, newTransitionFrameUID);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTransitionFrameUID(StringUIDBaseType newTransitionFrameUID) {
		if (newTransitionFrameUID != transitionFrameUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__TRANSITION_FRAME_UID,
					newTransitionFrameUID, newTransitionFrameUID));
	}
	...
	public NotificationChain basicSetFwdLatPanelLowY(DoubleBaseType newFwdLatPanelLowY, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_LOW_Y, oldFwdLatPanelLowY,
					newFwdLatPanelLowY);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFwdLatPanelLowY != fwdLatPanelLowY) {
			...
			if (fwdLatPanelLowY != null)
				msgs = ((InternalEObject) fwdLatPanelLowY).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_LOW_Y,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_LOW_Y, newFwdLatPanelLowY,
					newFwdLatPanelLowY));
	}
	...
	public NotificationChain basicSetFwdLatPanelSheetUID(StringUIDBaseType newFwdLatPanelSheetUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_SHEET_UID,
					oldFwdLatPanelSheetUID, newFwdLatPanelSheetUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setFwdLatPanelSheetUID(StringUIDBaseType newFwdLatPanelSheetUID) {
		if (newFwdLatPanelSheetUID != fwdLatPanelSheetUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_SHEET_UID,
					newFwdLatPanelSheetUID, newFwdLatPanelSheetUID));
	}
	...
	public NotificationChain basicSetFwdLatPanelReinforcementUID(StringUIDBaseType newFwdLatPanelReinforcementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_REINFORCEMENT_UID,
	...
	public void setFwdLatPanelReinforcementUID(StringUIDBaseType newFwdLatPanelReinforcementUID) {
		if (newFwdLatPanelReinforcementUID != fwdLatPanelReinforcementUID) {
			...
			if (fwdLatPanelReinforcementUID != null)
				msgs = ((InternalEObject) fwdLatPanelReinforcementUID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_REINFORCEMENT_UID,
						null, msgs);
			if (newFwdLatPanelReinforcementUID != null)
				msgs = ((InternalEObject) newFwdLatPanelReinforcementUID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_REINFORCEMENT_UID,
						null, msgs);
	...
	public NotificationChain basicSetRearLatPanelHeightStringerUID(StringUIDBaseType newRearLatPanelHeightStringerUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_HEIGHT_STRINGER_UID,
	...
	public void setRearLatPanelHeightStringerUID(StringUIDBaseType newRearLatPanelHeightStringerUID) {
		if (newRearLatPanelHeightStringerUID != rearLatPanelHeightStringerUID) {
			...
			if (rearLatPanelHeightStringerUID != null)
				msgs = ((InternalEObject) rearLatPanelHeightStringerUID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_HEIGHT_STRINGER_UID,
						null, msgs);
			if (newRearLatPanelHeightStringerUID != null)
				msgs = ((InternalEObject) newRearLatPanelHeightStringerUID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_HEIGHT_STRINGER_UID,
						null, msgs);
	...
	public NotificationChain basicSetRearLatPanelSheetUID(StringUIDBaseType newRearLatPanelSheetUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_SHEET_UID,
					oldRearLatPanelSheetUID, newRearLatPanelSheetUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setRearLatPanelSheetUID(StringUIDBaseType newRearLatPanelSheetUID) {
		if (newRearLatPanelSheetUID != rearLatPanelSheetUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_SHEET_UID,
					newRearLatPanelSheetUID, newRearLatPanelSheetUID));
	}
	...
	public NotificationChain basicSetRearLatPanelReinforcementUID(StringUIDBaseType newRearLatPanelReinforcementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_REINFORCEMENT_UID,
	...
	public void setRearLatPanelReinforcementUID(StringUIDBaseType newRearLatPanelReinforcementUID) {
		if (newRearLatPanelReinforcementUID != rearLatPanelReinforcementUID) {
			...
			if (rearLatPanelReinforcementUID != null)
				msgs = ((InternalEObject) rearLatPanelReinforcementUID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_REINFORCEMENT_UID,
						null, msgs);
			if (newRearLatPanelReinforcementUID != null)
				msgs = ((InternalEObject) newRearLatPanelReinforcementUID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_REINFORCEMENT_UID,
						null, msgs);
	...
	public void setUID(String newUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__TRANSITION_FRAME_UID:
			return basicSetTransitionFrameUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_LOW_Y:
			return basicSetFwdLatPanelLowY(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_SHEET_UID:
			return basicSetFwdLatPanelSheetUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__FWD_LAT_PANEL_REINFORCEMENT_UID:
			return basicSetFwdLatPanelReinforcementUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_HEIGHT_STRINGER_UID:
			return basicSetRearLatPanelHeightStringerUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_SHEET_UID:
			return basicSetRearLatPanelSheetUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__REAR_LAT_PANEL_REINFORCEMENT_UID:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.LANDING_GEAR_INTERFACE_LATERAL_PANELS_TYPE__UID:
			return getUID();
		}
...
} //LandingGearInterfaceLateralPanelsTypeImpl
