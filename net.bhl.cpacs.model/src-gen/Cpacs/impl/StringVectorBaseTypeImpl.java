 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getA <em>A</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getB <em>B</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getC <em>C</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getDelta <em>Delta</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getMapType <em>Map Type</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getMu <em>Mu</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getUncertaintyFunctionName <em>Uncertainty Function Name</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getV <em>V</em>}</li>
 *   <li>{@link Cpacs.impl.StringVectorBaseTypeImpl#getW <em>W</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringVectorBaseTypeImpl extends StringBaseTypeImpl implements StringVectorBaseType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getStringVectorBaseType();
	}
	...
	public void setA(String newA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__A, oldA, a));
	}
	...
	public void setB(String newB) {
		...
		b = newB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__B, oldB, b));
	}
	...
	public void setC(String newC) {
		...
		c = newC;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__C, oldC, c));
	}
	...
	public void setDelta(String newDelta) {
		...
		delta = newDelta;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__DELTA, oldDelta,
					delta));
	}
	...
	public void setMapType(String newMapType) {
		...
		mapTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__MAP_TYPE,
	...
	public void unsetMapType() {
		...
		mapTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.STRING_VECTOR_BASE_TYPE__MAP_TYPE,
					oldMapType, MAP_TYPE_EDEFAULT, oldMapTypeESet));
	}
	...
	public void setMu(String newMu) {
		...
		mu = newMu;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__MU, oldMu, mu));
	}
	...
	public void setUncertaintyFunctionName(UncertaintyFunctionType newUncertaintyFunctionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.STRING_VECTOR_BASE_TYPE__UNCERTAINTY_FUNCTION_NAME, oldUncertaintyFunctionName,
	...
	public void setV(String newV) {
		...
		v = newV;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__V, oldV, v));
	}
	...
	public void setW(String newW) {
		...
		w = newW;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_VECTOR_BASE_TYPE__W, oldW, w));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__A:
			return getA();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__B:
			return getB();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__C:
			return getC();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__DELTA:
			return getDelta();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__MAP_TYPE:
			return getMapType();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__MU:
			return getMu();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__UNCERTAINTY_FUNCTION_NAME:
			return getUncertaintyFunctionName();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__V:
			return getV();
		case CpacsPackage.STRING_VECTOR_BASE_TYPE__W:
			return getW();
		}
