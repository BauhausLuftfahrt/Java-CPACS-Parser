...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Point List XYZ Vector Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.PointListXYZVectorTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link Cpacs.impl.PointListXYZVectorTypeImpl#getY <em>Y</em>}</li>
 *   <li>{@link Cpacs.impl.PointListXYZVectorTypeImpl#getZ <em>Z</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointListXYZVectorTypeImpl extends ComplexBaseTypeImpl implements PointListXYZVectorType {
	/**
	 ...
	 * @generated
	 */
	protected PointListXYZVectorTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getPointListXYZVectorType();
	}
	...
	public NotificationChain basicSetX(StringVectorBaseType newX, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__X, oldX, newX);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newX != x) {
			...
			if (x != null)
				msgs = ((InternalEObject) x).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__X, null, msgs);
			if (newX != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__X, newX,
					newX));
	}
	...
	public NotificationChain basicSetY(StringVectorBaseType newY, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Y, oldY, newY);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newY != y) {
			...
			if (y != null)
				msgs = ((InternalEObject) y).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Y, null, msgs);
			if (newY != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Y, newY,
					newY));
	}
	...
	public NotificationChain basicSetZ(StringVectorBaseType newZ, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Z, oldZ, newZ);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newZ != z) {
			...
			if (z != null)
				msgs = ((InternalEObject) z).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Z, null, msgs);
			if (newZ != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Z, newZ,
					newZ));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__X:
			return basicSetX(null, msgs);
		case CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Y:
			return basicSetY(null, msgs);
		case CpacsPackage.POINT_LIST_XYZ_VECTOR_TYPE__Z:
