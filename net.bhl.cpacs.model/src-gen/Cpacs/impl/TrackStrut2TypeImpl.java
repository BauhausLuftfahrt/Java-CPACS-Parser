...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Track Strut2 Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.TrackStrut2TypeImpl#getMaterial <em>Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrackStrut2TypeImpl extends ComplexBaseTypeImpl implements TrackStrut2Type {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getTrackStrut2Type();
	}
	...
	public NotificationChain basicSetMaterial(MaterialDefinitionType newMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.TRACK_STRUT2_TYPE__MATERIAL, oldMaterial, newMaterial);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMaterial != material) {
			...
			if (material != null)
				msgs = ((InternalEObject) material).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.TRACK_STRUT2_TYPE__MATERIAL, null, msgs);
			if (newMaterial != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TRACK_STRUT2_TYPE__MATERIAL, newMaterial,
					newMaterial));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.TRACK_STRUT2_TYPE__MATERIAL:
