...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Landing Gear Interface Pressure Floor Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.LandingGearInterfacePressureFloorTypeImpl#getPositionZStringerUID <em>Position ZStringer UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfacePressureFloorTypeImpl#getMembraneRadius <em>Membrane Radius</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfacePressureFloorTypeImpl#getSheetElementUID <em>Sheet Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfacePressureFloorTypeImpl#getReinforcementElementUID <em>Reinforcement Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfacePressureFloorTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LandingGearInterfacePressureFloorTypeImpl extends ComplexBaseTypeImpl
		implements LandingGearInterfacePressureFloorType {
	/**
	 ...
	 * @generated
	 */
	protected LandingGearInterfacePressureFloorTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getLandingGearInterfacePressureFloorType();
	}
	...
	public NotificationChain basicSetPositionZStringerUID(StringUIDBaseType newPositionZStringerUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__POSITION_ZSTRINGER_UID,
					oldPositionZStringerUID, newPositionZStringerUID);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPositionZStringerUID(StringUIDBaseType newPositionZStringerUID) {
		if (newPositionZStringerUID != positionZStringerUID) {
			...
			if (positionZStringerUID != null)
				msgs = ((InternalEObject) positionZStringerUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__POSITION_ZSTRINGER_UID,
						null, msgs);
			if (newPositionZStringerUID != null)
				msgs = ((InternalEObject) newPositionZStringerUID).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__POSITION_ZSTRINGER_UID,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__POSITION_ZSTRINGER_UID,
					newPositionZStringerUID, newPositionZStringerUID));
	}
	...
	public NotificationChain basicSetMembraneRadius(DoubleBaseType newMembraneRadius, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__MEMBRANE_RADIUS, oldMembraneRadius,
					newMembraneRadius);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMembraneRadius(DoubleBaseType newMembraneRadius) {
		if (newMembraneRadius != membraneRadius) {
			...
			if (membraneRadius != null)
				msgs = ((InternalEObject) membraneRadius).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__MEMBRANE_RADIUS, null, msgs);
			if (newMembraneRadius != null)
				msgs = ((InternalEObject) newMembraneRadius).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__MEMBRANE_RADIUS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__MEMBRANE_RADIUS, newMembraneRadius,
					newMembraneRadius));
	}
	...
	public NotificationChain basicSetSheetElementUID(StringUIDBaseType newSheetElementUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__SHEET_ELEMENT_UID, oldSheetElementUID,
					newSheetElementUID);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSheetElementUID != sheetElementUID) {
			...
			if (sheetElementUID != null)
				msgs = ((InternalEObject) sheetElementUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__SHEET_ELEMENT_UID,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__SHEET_ELEMENT_UID, newSheetElementUID,
					newSheetElementUID));
	}
	...
	public NotificationChain basicSetReinforcementElementUID(StringUIDBaseType newReinforcementElementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__REINFORCEMENT_ELEMENT_UID,
	...
	public void setUID(String newUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__POSITION_ZSTRINGER_UID:
			return basicSetPositionZStringerUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__MEMBRANE_RADIUS:
			return basicSetMembraneRadius(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__SHEET_ELEMENT_UID:
			return basicSetSheetElementUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__REINFORCEMENT_ELEMENT_UID:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.LANDING_GEAR_INTERFACE_PRESSURE_FLOOR_TYPE__UID:
			return getUID();
		}
...
} //LandingGearInterfacePressureFloorTypeImpl
