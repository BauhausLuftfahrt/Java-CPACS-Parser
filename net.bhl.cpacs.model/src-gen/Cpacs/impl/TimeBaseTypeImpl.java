 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.TimeBaseTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Cpacs.impl.TimeBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link Cpacs.impl.TimeBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link Cpacs.impl.TimeBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeBaseTypeImpl extends MinimalEObjectImpl.Container implements TimeBaseType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getTimeBaseType();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TIME_BASE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TIME_BASE_TYPE__EXTERNAL_DATA_DIRECTORY,
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TIME_BASE_TYPE__EXTERNAL_DATA_NODE_PATH,
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TIME_BASE_TYPE__EXTERNAL_FILE_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.TIME_BASE_TYPE__VALUE:
			return getValue();
		case CpacsPackage.TIME_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case CpacsPackage.TIME_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case CpacsPackage.TIME_BASE_TYPE__EXTERNAL_FILE_NAME:
