...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Track Car Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.TrackCarTypeImpl#getMaterial <em>Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrackCarTypeImpl extends ComplexBaseTypeImpl implements TrackCarType {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getTrackCarType();
	}
	...
	public NotificationChain basicSetMaterial(MaterialDefinitionType newMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.TRACK_CAR_TYPE__MATERIAL, oldMaterial, newMaterial);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMaterial != material) {
			...
			if (material != null)
				msgs = ((InternalEObject) material).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.TRACK_CAR_TYPE__MATERIAL, null, msgs);
			if (newMaterial != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TRACK_CAR_TYPE__MATERIAL, newMaterial,
					newMaterial));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.TRACK_CAR_TYPE__MATERIAL:
