...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Topology Entry Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.TopologyEntryTypeImpl#getDamPoint1UID <em>Dam Point1 UID</em>}</li>
 *   <li>{@link Cpacs.impl.TopologyEntryTypeImpl#getDamPoint2UID <em>Dam Point2 UID</em>}</li>
 *   <li>{@link Cpacs.impl.TopologyEntryTypeImpl#getRotation <em>Rotation</em>}</li>
 *   <li>{@link Cpacs.impl.TopologyEntryTypeImpl#getStiffness <em>Stiffness</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopologyEntryTypeImpl extends ComplexBaseTypeImpl implements TopologyEntryType {
	/**
	 ...
	 * @generated
	 */
	protected TopologyEntryTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getTopologyEntryType();
	}
	...
	public NotificationChain basicSetDamPoint1UID(StringUIDBaseType newDamPoint1UID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT1_UID, oldDamPoint1UID, newDamPoint1UID);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDamPoint1UID != damPoint1UID) {
			...
			if (damPoint1UID != null)
				msgs = ((InternalEObject) damPoint1UID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT1_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT1_UID,
	...
	public NotificationChain basicSetDamPoint2UID(StringUIDBaseType newDamPoint2UID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT2_UID, oldDamPoint2UID, newDamPoint2UID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDamPoint2UID != damPoint2UID) {
			...
			if (damPoint2UID != null)
				msgs = ((InternalEObject) damPoint2UID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT2_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT2_UID,
	...
	public NotificationChain basicSetRotation(PointXYZType newRotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.TOPOLOGY_ENTRY_TYPE__ROTATION, oldRotation, newRotation);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRotation != rotation) {
			...
			if (rotation != null)
				msgs = ((InternalEObject) rotation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.TOPOLOGY_ENTRY_TYPE__ROTATION, null, msgs);
			if (newRotation != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TOPOLOGY_ENTRY_TYPE__ROTATION,
	...
	public NotificationChain basicSetStiffness(StiffnessType newStiffness, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.TOPOLOGY_ENTRY_TYPE__STIFFNESS, oldStiffness, newStiffness);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newStiffness != stiffness) {
			...
			if (stiffness != null)
				msgs = ((InternalEObject) stiffness).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.TOPOLOGY_ENTRY_TYPE__STIFFNESS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.TOPOLOGY_ENTRY_TYPE__STIFFNESS,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT1_UID:
			return basicSetDamPoint1UID(null, msgs);
		case CpacsPackage.TOPOLOGY_ENTRY_TYPE__DAM_POINT2_UID:
			return basicSetDamPoint2UID(null, msgs);
		case CpacsPackage.TOPOLOGY_ENTRY_TYPE__ROTATION:
			return basicSetRotation(null, msgs);
		case CpacsPackage.TOPOLOGY_ENTRY_TYPE__STIFFNESS:
