...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ZCoupling Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.ZCouplingTypeImpl#getToControlSurfaceUID <em>To Control Surface UID</em>}</li>
 *   <li>{@link Cpacs.impl.ZCouplingTypeImpl#getMaterial <em>Material</em>}</li>
 *   <li>{@link Cpacs.impl.ZCouplingTypeImpl#getFromAttachment <em>From Attachment</em>}</li>
 *   <li>{@link Cpacs.impl.ZCouplingTypeImpl#getToAttachment <em>To Attachment</em>}</li>
 *   <li>{@link Cpacs.impl.ZCouplingTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZCouplingTypeImpl extends ComplexBaseTypeImpl implements ZCouplingType {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getZCouplingType();
	}
	...
	public NotificationChain basicSetToControlSurfaceUID(StringUIDBaseType newToControlSurfaceUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ZCOUPLING_TYPE__TO_CONTROL_SURFACE_UID, oldToControlSurfaceUID,
		...
		if (newToControlSurfaceUID != toControlSurfaceUID) {
			...
			if (toControlSurfaceUID != null)
				msgs = ((InternalEObject) toControlSurfaceUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ZCOUPLING_TYPE__TO_CONTROL_SURFACE_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ZCOUPLING_TYPE__TO_CONTROL_SURFACE_UID,
					newToControlSurfaceUID, newToControlSurfaceUID));
	}
	...
	public NotificationChain basicSetMaterial(MaterialDefinitionType newMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ZCOUPLING_TYPE__MATERIAL, oldMaterial, newMaterial);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMaterial != material) {
			...
			if (material != null)
				msgs = ((InternalEObject) material).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ZCOUPLING_TYPE__MATERIAL, null, msgs);
			if (newMaterial != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ZCOUPLING_TYPE__MATERIAL, newMaterial,
					newMaterial));
	}
	...
	public NotificationChain basicSetFromAttachment(InterConnectionStrutAttachmentType newFromAttachment,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ZCOUPLING_TYPE__FROM_ATTACHMENT, oldFromAttachment, newFromAttachment);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFromAttachment != fromAttachment) {
			...
			if (fromAttachment != null)
				msgs = ((InternalEObject) fromAttachment).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ZCOUPLING_TYPE__FROM_ATTACHMENT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ZCOUPLING_TYPE__FROM_ATTACHMENT,
					newFromAttachment, newFromAttachment));
	}
	...
	public NotificationChain basicSetToAttachment(InterConnectionStrutAttachmentType newToAttachment,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ZCOUPLING_TYPE__TO_ATTACHMENT, oldToAttachment, newToAttachment);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newToAttachment != toAttachment) {
			...
			if (toAttachment != null)
				msgs = ((InternalEObject) toAttachment).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ZCOUPLING_TYPE__TO_ATTACHMENT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ZCOUPLING_TYPE__TO_ATTACHMENT,
					newToAttachment, newToAttachment));
	}
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ZCOUPLING_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.ZCOUPLING_TYPE__TO_CONTROL_SURFACE_UID:
			return basicSetToControlSurfaceUID(null, msgs);
		case CpacsPackage.ZCOUPLING_TYPE__MATERIAL:
			return basicSetMaterial(null, msgs);
		case CpacsPackage.ZCOUPLING_TYPE__FROM_ATTACHMENT:
			return basicSetFromAttachment(null, msgs);
		case CpacsPackage.ZCOUPLING_TYPE__TO_ATTACHMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.ZCOUPLING_TYPE__UID:
			return getUID();
		}
