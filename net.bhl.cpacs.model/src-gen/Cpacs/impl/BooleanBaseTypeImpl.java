 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.BooleanBaseTypeImpl#isValue <em>Value</em>}</li>
 *   <li>{@link Cpacs.impl.BooleanBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link Cpacs.impl.BooleanBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link Cpacs.impl.BooleanBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanBaseTypeImpl extends MinimalEObjectImpl.Container implements BooleanBaseType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getBooleanBaseType();
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.BOOLEAN_BASE_TYPE__VALUE, oldValue,
					value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.BOOLEAN_BASE_TYPE__VALUE, oldValue,
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.BOOLEAN_BASE_TYPE__EXTERNAL_DATA_DIRECTORY, oldExternalDataDirectory,
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.BOOLEAN_BASE_TYPE__EXTERNAL_DATA_NODE_PATH, oldExternalDataNodePath,
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.BOOLEAN_BASE_TYPE__EXTERNAL_FILE_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.BOOLEAN_BASE_TYPE__VALUE:
			return isValue();
		case CpacsPackage.BOOLEAN_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case CpacsPackage.BOOLEAN_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case CpacsPackage.BOOLEAN_BASE_TYPE__EXTERNAL_FILE_NAME:
