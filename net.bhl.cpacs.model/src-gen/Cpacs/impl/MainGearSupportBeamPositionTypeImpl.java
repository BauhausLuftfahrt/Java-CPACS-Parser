...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Main Gear Support Beam Position Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.MainGearSupportBeamPositionTypeImpl#getXsiInside <em>Xsi Inside</em>}</li>
 *   <li>{@link Cpacs.impl.MainGearSupportBeamPositionTypeImpl#getEtaOutside <em>Eta Outside</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MainGearSupportBeamPositionTypeImpl extends ComplexBaseTypeImpl
		implements MainGearSupportBeamPositionType {
	/**
	 ...
	 * @generated
	 */
	protected MainGearSupportBeamPositionTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getMainGearSupportBeamPositionType();
	}
	...
	public NotificationChain basicSetXsiInside(XsiIsoLineType newXsiInside, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__XSI_INSIDE, oldXsiInside, newXsiInside);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newXsiInside != xsiInside) {
			...
			if (xsiInside != null)
				msgs = ((InternalEObject) xsiInside).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__XSI_INSIDE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__XSI_INSIDE, newXsiInside, newXsiInside));
	}
	...
	public NotificationChain basicSetEtaOutside(EtaIsoLineType newEtaOutside, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__ETA_OUTSIDE, oldEtaOutside, newEtaOutside);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newEtaOutside != etaOutside) {
			...
			if (etaOutside != null)
				msgs = ((InternalEObject) etaOutside).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__ETA_OUTSIDE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__ETA_OUTSIDE, newEtaOutside, newEtaOutside));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__XSI_INSIDE:
			return basicSetXsiInside(null, msgs);
		case CpacsPackage.MAIN_GEAR_SUPPORT_BEAM_POSITION_TYPE__ETA_OUTSIDE:
...
} //MainGearSupportBeamPositionTypeImpl
