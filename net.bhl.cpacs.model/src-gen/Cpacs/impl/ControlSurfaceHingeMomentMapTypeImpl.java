...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Control Surface Hinge Moment Map Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getControlSurfaceUID <em>Control Surface UID</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getControlParameters <em>Control Parameters</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getDcd <em>Dcd</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getDcs <em>Dcs</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getDcl <em>Dcl</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getDcmd <em>Dcmd</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getDcms <em>Dcms</em>}</li>
 *   <li>{@link Cpacs.impl.ControlSurfaceHingeMomentMapTypeImpl#getDcml <em>Dcml</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlSurfaceHingeMomentMapTypeImpl extends ComplexBaseTypeImpl
		implements ControlSurfaceHingeMomentMapType {
	/**
	 ...
	 * @generated
	 */
	protected ControlSurfaceHingeMomentMapTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getControlSurfaceHingeMomentMapType();
	}
	...
	public NotificationChain basicSetControlSurfaceUID(StringUIDBaseType newControlSurfaceUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_SURFACE_UID, oldControlSurfaceUID,
		...
		if (newControlSurfaceUID != controlSurfaceUID) {
			...
			if (controlSurfaceUID != null)
				msgs = ((InternalEObject) controlSurfaceUID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_SURFACE_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_SURFACE_UID, newControlSurfaceUID,
					newControlSurfaceUID));
	}
	...
	public NotificationChain basicSetControlParameters(StringVectorBaseType newControlParameters,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_PARAMETERS, oldControlParameters,
		...
		if (newControlParameters != controlParameters) {
			...
			if (controlParameters != null)
				msgs = ((InternalEObject) controlParameters).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_PARAMETERS,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_PARAMETERS, newControlParameters,
					newControlParameters));
	}
	...
	public NotificationChain basicSetDcd(StringArrayBaseType newDcd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCD, oldDcd, newDcd);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDcd != dcd) {
			...
			if (dcd != null)
				msgs = ((InternalEObject) dcd).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCD, null, msgs);
			if (newDcd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCD, newDcd, newDcd));
	}
	...
	public NotificationChain basicSetDcs(StringArrayBaseType newDcs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCS, oldDcs, newDcs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDcs != dcs) {
			...
			if (dcs != null)
				msgs = ((InternalEObject) dcs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCS, null, msgs);
			if (newDcs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCS, newDcs, newDcs));
	}
	...
	public NotificationChain basicSetDcl(StringArrayBaseType newDcl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCL, oldDcl, newDcl);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDcl != dcl) {
			...
			if (dcl != null)
				msgs = ((InternalEObject) dcl).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCL, null, msgs);
			if (newDcl != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCL, newDcl, newDcl));
	}
	...
	public NotificationChain basicSetDcmd(StringArrayBaseType newDcmd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMD, oldDcmd, newDcmd);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDcmd != dcmd) {
			...
			if (dcmd != null)
				msgs = ((InternalEObject) dcmd).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMD, null, msgs);
			if (newDcmd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMD, newDcmd, newDcmd));
	}
	...
	public NotificationChain basicSetDcms(StringArrayBaseType newDcms, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMS, oldDcms, newDcms);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDcms != dcms) {
			...
			if (dcms != null)
				msgs = ((InternalEObject) dcms).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMS, null, msgs);
			if (newDcms != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMS, newDcms, newDcms));
	}
	...
	public NotificationChain basicSetDcml(StringArrayBaseType newDcml, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCML, oldDcml, newDcml);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDcml != dcml) {
			...
			if (dcml != null)
				msgs = ((InternalEObject) dcml).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCML, null, msgs);
			if (newDcml != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCML, newDcml, newDcml));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_SURFACE_UID:
			return basicSetControlSurfaceUID(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__CONTROL_PARAMETERS:
			return basicSetControlParameters(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCD:
			return basicSetDcd(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCS:
			return basicSetDcs(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCL:
			return basicSetDcl(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMD:
			return basicSetDcmd(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCMS:
			return basicSetDcms(null, msgs);
		case CpacsPackage.CONTROL_SURFACE_HINGE_MOMENT_MAP_TYPE__DCML:
...
} //ControlSurfaceHingeMomentMapTypeImpl
