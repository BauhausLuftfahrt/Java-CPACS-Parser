 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.IntegerBaseTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Cpacs.impl.IntegerBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link Cpacs.impl.IntegerBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link Cpacs.impl.IntegerBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerBaseTypeImpl extends MinimalEObjectImpl.Container implements IntegerBaseType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getIntegerBaseType();
	}
	...
	public void setValue(BigInteger newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.INTEGER_BASE_TYPE__VALUE, oldValue,
					value));
	}
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.INTEGER_BASE_TYPE__EXTERNAL_DATA_DIRECTORY, oldExternalDataDirectory,
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.INTEGER_BASE_TYPE__EXTERNAL_DATA_NODE_PATH, oldExternalDataNodePath,
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.INTEGER_BASE_TYPE__EXTERNAL_FILE_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.INTEGER_BASE_TYPE__VALUE:
			return getValue();
		case CpacsPackage.INTEGER_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case CpacsPackage.INTEGER_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case CpacsPackage.INTEGER_BASE_TYPE__EXTERNAL_FILE_NAME:
