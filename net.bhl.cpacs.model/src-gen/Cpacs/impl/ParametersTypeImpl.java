 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.ParametersTypeImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersTypeImpl extends ComplexBaseTypeImpl implements ParametersType {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getParametersType();
	}
	...
	public EList<ParameterType> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<ParameterType>(ParameterType.class, this,
					CpacsPackage.PARAMETERS_TYPE__PARAMETER);
		}
		return parameter;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.PARAMETERS_TYPE__PARAMETER:
