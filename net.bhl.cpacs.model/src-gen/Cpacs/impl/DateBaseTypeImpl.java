...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Date Base Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.DateBaseTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Cpacs.impl.DateBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link Cpacs.impl.DateBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link Cpacs.impl.DateBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateBaseTypeImpl extends MinimalEObjectImpl.Container implements DateBaseType {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getDateBaseType();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DATE_BASE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DATE_BASE_TYPE__EXTERNAL_DATA_DIRECTORY,
					oldExternalDataDirectory, externalDataDirectory));
	}
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DATE_BASE_TYPE__EXTERNAL_DATA_NODE_PATH,
					oldExternalDataNodePath, externalDataNodePath));
	}
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DATE_BASE_TYPE__EXTERNAL_FILE_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.DATE_BASE_TYPE__VALUE:
			return getValue();
		case CpacsPackage.DATE_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case CpacsPackage.DATE_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case CpacsPackage.DATE_BASE_TYPE__EXTERNAL_FILE_NAME:
