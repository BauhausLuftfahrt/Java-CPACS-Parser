...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Flight Load Case Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getAeroDataSetUID <em>Aero Data Set UID</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getLoadCondition <em>Load Condition</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getState <em>State</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getAircraftSettings <em>Aircraft Settings</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getMass <em>Mass</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getNodalLoads <em>Nodal Loads</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getCutLoads <em>Cut Loads</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getExternalAmifFile <em>External Amif File</em>}</li>
 *   <li>{@link Cpacs.impl.FlightLoadCaseTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlightLoadCaseTypeImpl extends ComplexBaseTypeImpl implements FlightLoadCaseType {
	/**
	 ...
	 * @generated
	 */
	protected FlightLoadCaseTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getFlightLoadCaseType();
	}
	...
	public NotificationChain basicSetName(StringBaseType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NAME, newName,
					newName));
	}
	...
	public NotificationChain basicSetDescription(StringBaseType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject) description).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__DESCRIPTION,
	...
	public NotificationChain basicSetAeroDataSetUID(StringUIDBaseType newAeroDataSetUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AERO_DATA_SET_UID, oldAeroDataSetUID, newAeroDataSetUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newAeroDataSetUID != aeroDataSetUID) {
			...
			if (aeroDataSetUID != null)
				msgs = ((InternalEObject) aeroDataSetUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AERO_DATA_SET_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AERO_DATA_SET_UID,
	...
	public NotificationChain basicSetLoadCondition(LoadConditionType newLoadCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__LOAD_CONDITION, oldLoadCondition, newLoadCondition);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLoadCondition != loadCondition) {
			...
			if (loadCondition != null)
				msgs = ((InternalEObject) loadCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__LOAD_CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__LOAD_CONDITION,
	...
	public NotificationChain basicSetState(LoadCaseStateType newState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__STATE, oldState, newState);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newState != state) {
			...
			if (state != null)
				msgs = ((InternalEObject) state).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__STATE, null, msgs);
			if (newState != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__STATE, newState,
					newState));
	}
	...
	public NotificationChain basicSetAircraftSettings(LoadCaseSettingsType newAircraftSettings,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AIRCRAFT_SETTINGS, oldAircraftSettings, newAircraftSettings);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newAircraftSettings != aircraftSettings) {
			...
			if (aircraftSettings != null)
				msgs = ((InternalEObject) aircraftSettings).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AIRCRAFT_SETTINGS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AIRCRAFT_SETTINGS,
	...
	public NotificationChain basicSetMass(LoadCaseMassType newMass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__MASS, oldMass, newMass);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMass != mass) {
			...
			if (mass != null)
				msgs = ((InternalEObject) mass).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__MASS, null, msgs);
			if (newMass != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__MASS, newMass,
					newMass));
	}
	...
	public NotificationChain basicSetNodalLoads(NodalLoadsType newNodalLoads, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NODAL_LOADS, oldNodalLoads, newNodalLoads);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newNodalLoads != nodalLoads) {
			...
			if (nodalLoads != null)
				msgs = ((InternalEObject) nodalLoads).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NODAL_LOADS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NODAL_LOADS,
	...
	public NotificationChain basicSetCutLoads(CutLoadsType newCutLoads, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__CUT_LOADS, oldCutLoads, newCutLoads);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCutLoads != cutLoads) {
			...
			if (cutLoads != null)
				msgs = ((InternalEObject) cutLoads).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__CUT_LOADS, null, msgs);
			if (newCutLoads != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__CUT_LOADS,
	...
	public NotificationChain basicSetExternalAmifFile(StringBaseType newExternalAmifFile, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__EXTERNAL_AMIF_FILE, oldExternalAmifFile, newExternalAmifFile);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newExternalAmifFile != externalAmifFile) {
			...
			if (externalAmifFile != null)
				msgs = ((InternalEObject) externalAmifFile).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_LOAD_CASE_TYPE__EXTERNAL_AMIF_FILE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_LOAD_CASE_TYPE__EXTERNAL_AMIF_FILE, newExternalAmifFile, newExternalAmifFile));
	}
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_LOAD_CASE_TYPE__UID, oldUID,
					uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NAME:
			return basicSetName(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__DESCRIPTION:
			return basicSetDescription(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AERO_DATA_SET_UID:
			return basicSetAeroDataSetUID(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__LOAD_CONDITION:
			return basicSetLoadCondition(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__STATE:
			return basicSetState(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__AIRCRAFT_SETTINGS:
			return basicSetAircraftSettings(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__MASS:
			return basicSetMass(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__NODAL_LOADS:
			return basicSetNodalLoads(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__CUT_LOADS:
			return basicSetCutLoads(null, msgs);
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__EXTERNAL_AMIF_FILE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.FLIGHT_LOAD_CASE_TYPE__UID:
			return getUID();
		}
