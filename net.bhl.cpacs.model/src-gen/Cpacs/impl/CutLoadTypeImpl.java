...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cut Load Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getParentUID <em>Parent UID</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getFx <em>Fx</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getFy <em>Fy</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getFz <em>Fz</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getMx <em>Mx</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getMy <em>My</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getMz <em>Mz</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getLoadBreakdown <em>Load Breakdown</em>}</li>
 *   <li>{@link Cpacs.impl.CutLoadTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CutLoadTypeImpl extends ComplexBaseTypeImpl implements CutLoadType {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getCutLoadType();
	}
	...
	public NotificationChain basicSetName(StringBaseType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetDescription(StringBaseType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject) description).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__DESCRIPTION,
	...
	public NotificationChain basicSetParentUID(StringUIDBaseType newParentUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__PARENT_UID, oldParentUID, newParentUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newParentUID != parentUID) {
			...
			if (parentUID != null)
				msgs = ((InternalEObject) parentUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__PARENT_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__PARENT_UID, newParentUID,
					newParentUID));
	}
	...
	public NotificationChain basicSetFx(StringVectorBaseType newFx, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__FX, oldFx, newFx);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFx != fx) {
			...
			if (fx != null)
				msgs = ((InternalEObject) fx).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__FX, null, msgs);
			if (newFx != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__FX, newFx, newFx));
	}
	...
	public NotificationChain basicSetFy(StringVectorBaseType newFy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__FY, oldFy, newFy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFy != fy) {
			...
			if (fy != null)
				msgs = ((InternalEObject) fy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__FY, null, msgs);
			if (newFy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__FY, newFy, newFy));
	}
	...
	public NotificationChain basicSetFz(StringVectorBaseType newFz, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__FZ, oldFz, newFz);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFz != fz) {
			...
			if (fz != null)
				msgs = ((InternalEObject) fz).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__FZ, null, msgs);
			if (newFz != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__FZ, newFz, newFz));
	}
	...
	public NotificationChain basicSetMx(StringVectorBaseType newMx, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__MX, oldMx, newMx);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMx != mx) {
			...
			if (mx != null)
				msgs = ((InternalEObject) mx).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__MX, null, msgs);
			if (newMx != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__MX, newMx, newMx));
	}
	...
	public NotificationChain basicSetMy(StringVectorBaseType newMy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__MY, oldMy, newMy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMy != my) {
			...
			if (my != null)
				msgs = ((InternalEObject) my).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__MY, null, msgs);
			if (newMy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__MY, newMy, newMy));
	}
	...
	public NotificationChain basicSetMz(StringVectorBaseType newMz, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__MZ, oldMz, newMz);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMz != mz) {
			...
			if (mz != null)
				msgs = ((InternalEObject) mz).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__MZ, null, msgs);
			if (newMz != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__MZ, newMz, newMz));
	}
	...
	public NotificationChain basicSetLoadBreakdown(LoadBreakdownType newLoadBreakdown, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.CUT_LOAD_TYPE__LOAD_BREAKDOWN, oldLoadBreakdown, newLoadBreakdown);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLoadBreakdown != loadBreakdown) {
			...
			if (loadBreakdown != null)
				msgs = ((InternalEObject) loadBreakdown).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.CUT_LOAD_TYPE__LOAD_BREAKDOWN, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__LOAD_BREAKDOWN,
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.CUT_LOAD_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.CUT_LOAD_TYPE__NAME:
			return basicSetName(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__DESCRIPTION:
			return basicSetDescription(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__PARENT_UID:
			return basicSetParentUID(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__FX:
			return basicSetFx(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__FY:
			return basicSetFy(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__FZ:
			return basicSetFz(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__MX:
			return basicSetMx(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__MY:
			return basicSetMy(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__MZ:
			return basicSetMz(null, msgs);
		case CpacsPackage.CUT_LOAD_TYPE__LOAD_BREAKDOWN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.CUT_LOAD_TYPE__UID:
			return getUID();
		}
