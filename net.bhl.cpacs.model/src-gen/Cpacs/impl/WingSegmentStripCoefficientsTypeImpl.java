...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Wing Segment Strip Coefficients Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getCfx <em>Cfx</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getCfy <em>Cfy</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getCfz <em>Cfz</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getCmx <em>Cmx</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getCmy <em>Cmy</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getCmz <em>Cmz</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentStripCoefficientsTypeImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WingSegmentStripCoefficientsTypeImpl extends ComplexBaseTypeImpl
		implements WingSegmentStripCoefficientsType {
	/**
	 ...
	 * @generated
	 */
	protected WingSegmentStripCoefficientsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getWingSegmentStripCoefficientsType();
	}
	...
	public NotificationChain basicSetCfx(DoubleBaseType newCfx, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFX, oldCfx, newCfx);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCfx != cfx) {
			...
			if (cfx != null)
				msgs = ((InternalEObject) cfx).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFX, null, msgs);
			if (newCfx != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFX, newCfx, newCfx));
	}
	...
	public NotificationChain basicSetCfy(DoubleBaseType newCfy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFY, oldCfy, newCfy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCfy != cfy) {
			...
			if (cfy != null)
				msgs = ((InternalEObject) cfy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFY, null, msgs);
			if (newCfy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFY, newCfy, newCfy));
	}
	...
	public NotificationChain basicSetCfz(DoubleBaseType newCfz, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFZ, oldCfz, newCfz);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCfz != cfz) {
			...
			if (cfz != null)
				msgs = ((InternalEObject) cfz).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFZ, null, msgs);
			if (newCfz != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFZ, newCfz, newCfz));
	}
	...
	public NotificationChain basicSetCmx(DoubleBaseType newCmx, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMX, oldCmx, newCmx);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCmx != cmx) {
			...
			if (cmx != null)
				msgs = ((InternalEObject) cmx).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMX, null, msgs);
			if (newCmx != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMX, newCmx, newCmx));
	}
	...
	public NotificationChain basicSetCmy(DoubleBaseType newCmy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMY, oldCmy, newCmy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCmy != cmy) {
			...
			if (cmy != null)
				msgs = ((InternalEObject) cmy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMY, null, msgs);
			if (newCmy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMY, newCmy, newCmy));
	}
	...
	public NotificationChain basicSetCmz(DoubleBaseType newCmz, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMZ, oldCmz, newCmz);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCmz != cmz) {
			...
			if (cmz != null)
				msgs = ((InternalEObject) cmz).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMZ, null, msgs);
			if (newCmz != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMZ, newCmz, newCmz));
	}
	...
	public NotificationChain basicSetReference(LoadReferenceType newReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__REFERENCE, oldReference, newReference);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newReference != reference) {
			...
			if (reference != null)
				msgs = ((InternalEObject) reference).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__REFERENCE, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__REFERENCE, newReference, newReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFX:
			return basicSetCfx(null, msgs);
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFY:
			return basicSetCfy(null, msgs);
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CFZ:
			return basicSetCfz(null, msgs);
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMX:
			return basicSetCmx(null, msgs);
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMY:
			return basicSetCmy(null, msgs);
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__CMZ:
			return basicSetCmz(null, msgs);
		case CpacsPackage.WING_SEGMENT_STRIP_COEFFICIENTS_TYPE__REFERENCE:
...
} //WingSegmentStripCoefficientsTypeImpl
