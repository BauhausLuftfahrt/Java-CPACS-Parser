...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Point Abs Rel Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.PointAbsRelTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link Cpacs.impl.PointAbsRelTypeImpl#getY <em>Y</em>}</li>
 *   <li>{@link Cpacs.impl.PointAbsRelTypeImpl#getZ <em>Z</em>}</li>
 *   <li>{@link Cpacs.impl.PointAbsRelTypeImpl#getRefType <em>Ref Type</em>}</li>
 *   <li>{@link Cpacs.impl.PointAbsRelTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointAbsRelTypeImpl extends ComplexBaseTypeImpl implements PointAbsRelType {
	/**
	 ...
	 * @ordered
	 */
	protected static final RefTypeType REF_TYPE_EDEFAULT = RefTypeType.ABS_LOCAL;
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getPointAbsRelType();
	}
	...
	public NotificationChain basicSetX(DoubleBaseType newX, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.POINT_ABS_REL_TYPE__X, oldX, newX);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newX != x) {
			...
			if (x != null)
				msgs = ((InternalEObject) x).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.POINT_ABS_REL_TYPE__X, null, msgs);
			if (newX != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_ABS_REL_TYPE__X, newX, newX));
	}
	...
	public NotificationChain basicSetY(DoubleBaseType newY, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.POINT_ABS_REL_TYPE__Y, oldY, newY);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newY != y) {
			...
			if (y != null)
				msgs = ((InternalEObject) y).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.POINT_ABS_REL_TYPE__Y, null, msgs);
			if (newY != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_ABS_REL_TYPE__Y, newY, newY));
	}
	...
	public NotificationChain basicSetZ(DoubleBaseType newZ, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.POINT_ABS_REL_TYPE__Z, oldZ, newZ);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newZ != z) {
			...
			if (z != null)
				msgs = ((InternalEObject) z).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.POINT_ABS_REL_TYPE__Z, null, msgs);
			if (newZ != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_ABS_REL_TYPE__Z, newZ, newZ));
	}
	...
	public void setRefType(RefTypeType newRefType) {
		...
		refTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_ABS_REL_TYPE__REF_TYPE, oldRefType,
					refType, !oldRefTypeESet));
	}
	...
	public void unsetRefType() {
		...
		refTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.POINT_ABS_REL_TYPE__REF_TYPE,
					oldRefType, REF_TYPE_EDEFAULT, oldRefTypeESet));
	}
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.POINT_ABS_REL_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.POINT_ABS_REL_TYPE__X:
			return basicSetX(null, msgs);
		case CpacsPackage.POINT_ABS_REL_TYPE__Y:
			return basicSetY(null, msgs);
		case CpacsPackage.POINT_ABS_REL_TYPE__Z:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.POINT_ABS_REL_TYPE__Z:
			return getZ();
		case CpacsPackage.POINT_ABS_REL_TYPE__REF_TYPE:
			return getRefType();
		case CpacsPackage.POINT_ABS_REL_TYPE__UID:
			return getUID();
		}
