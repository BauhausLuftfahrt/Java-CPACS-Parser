...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fuel Mass Fraction Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.FuelMassFractionTypeImpl#getFromSegmentUID <em>From Segment UID</em>}</li>
 *   <li>{@link Cpacs.impl.FuelMassFractionTypeImpl#getToSegmentUID <em>To Segment UID</em>}</li>
 *   <li>{@link Cpacs.impl.FuelMassFractionTypeImpl#getFraction <em>Fraction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FuelMassFractionTypeImpl extends ComplexBaseTypeImpl implements FuelMassFractionType {
	/**
	 ...
	 * @generated
	 */
	protected FuelMassFractionTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getFuelMassFractionType();
	}
	...
	public NotificationChain basicSetFromSegmentUID(StringUIDBaseType newFromSegmentUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FUEL_MASS_FRACTION_TYPE__FROM_SEGMENT_UID, oldFromSegmentUID, newFromSegmentUID);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFromSegmentUID != fromSegmentUID) {
			...
			if (fromSegmentUID != null)
				msgs = ((InternalEObject) fromSegmentUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FUEL_MASS_FRACTION_TYPE__FROM_SEGMENT_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FUEL_MASS_FRACTION_TYPE__FROM_SEGMENT_UID, newFromSegmentUID, newFromSegmentUID));
	}
	...
	public NotificationChain basicSetToSegmentUID(StringUIDBaseType newToSegmentUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FUEL_MASS_FRACTION_TYPE__TO_SEGMENT_UID, oldToSegmentUID, newToSegmentUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newToSegmentUID != toSegmentUID) {
			...
			if (toSegmentUID != null)
				msgs = ((InternalEObject) toSegmentUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FUEL_MASS_FRACTION_TYPE__TO_SEGMENT_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FUEL_MASS_FRACTION_TYPE__TO_SEGMENT_UID,
	...
	public NotificationChain basicSetFraction(DoubleBaseType newFraction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FUEL_MASS_FRACTION_TYPE__FRACTION, oldFraction, newFraction);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFraction != fraction) {
			...
			if (fraction != null)
				msgs = ((InternalEObject) fraction).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FUEL_MASS_FRACTION_TYPE__FRACTION, null, msgs);
			if (newFraction != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FUEL_MASS_FRACTION_TYPE__FRACTION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.FUEL_MASS_FRACTION_TYPE__FROM_SEGMENT_UID:
			return basicSetFromSegmentUID(null, msgs);
		case CpacsPackage.FUEL_MASS_FRACTION_TYPE__TO_SEGMENT_UID:
			return basicSetToSegmentUID(null, msgs);
		case CpacsPackage.FUEL_MASS_FRACTION_TYPE__FRACTION:
