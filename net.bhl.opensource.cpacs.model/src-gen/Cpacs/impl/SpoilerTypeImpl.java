...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Spoiler Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getParentUID <em>Parent UID</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getOuterShape <em>Outer Shape</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getWingCutOut <em>Wing Cut Out</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getPath <em>Path</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getTracks <em>Tracks</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getActuators <em>Actuators</em>}</li>
 *   <li>{@link Cpacs.impl.SpoilerTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpoilerTypeImpl extends ComplexBaseTypeImpl implements SpoilerType {
	/**
	 ...
	 * @ordered
	 */
	protected ControlSurfaceOuterShapeSpoilerType outerShape;
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getSpoilerType();
	}
	...
	public NotificationChain basicSetName(StringBaseType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetDescription(StringBaseType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject) description).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__DESCRIPTION,
	...
	public NotificationChain basicSetParentUID(StringUIDBaseType newParentUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__PARENT_UID, oldParentUID, newParentUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newParentUID != parentUID) {
			...
			if (parentUID != null)
				msgs = ((InternalEObject) parentUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__PARENT_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__PARENT_UID, newParentUID,
					newParentUID));
	}
	 ...
	 */
	@Override
	public ControlSurfaceOuterShapeSpoilerType getOuterShape() {
		return outerShape;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOuterShape(ControlSurfaceOuterShapeSpoilerType newOuterShape,
			NotificationChain msgs) {
		ControlSurfaceOuterShapeSpoilerType oldOuterShape = outerShape;
		outerShape = newOuterShape;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__OUTER_SHAPE, oldOuterShape, newOuterShape);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 */
	@Override
	public void setOuterShape(ControlSurfaceOuterShapeSpoilerType newOuterShape) {
		if (newOuterShape != outerShape) {
			NotificationChain msgs = null;
			if (outerShape != null)
				msgs = ((InternalEObject) outerShape).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__OUTER_SHAPE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__OUTER_SHAPE, newOuterShape,
					newOuterShape));
	}
	...
	public NotificationChain basicSetWingCutOut(ControlSurfaceWingCutOutType newWingCutOut, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__WING_CUT_OUT, oldWingCutOut, newWingCutOut);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newWingCutOut != wingCutOut) {
			...
			if (wingCutOut != null)
				msgs = ((InternalEObject) wingCutOut).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__WING_CUT_OUT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__WING_CUT_OUT,
	...
	public NotificationChain basicSetStructure(WingComponentSegmentStructureType newStructure, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__STRUCTURE, oldStructure, newStructure);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newStructure != structure) {
			...
			if (structure != null)
				msgs = ((InternalEObject) structure).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__STRUCTURE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__STRUCTURE, newStructure,
					newStructure));
	}
	...
	public NotificationChain basicSetPath(ControlSurfacePathType newPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__PATH, oldPath, newPath);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject) path).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__PATH, null, msgs);
			if (newPath != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__PATH, newPath, newPath));
	}
	...
	public NotificationChain basicSetTracks(ControlSurfaceTracksType newTracks, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__TRACKS, oldTracks, newTracks);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTracks != tracks) {
			...
			if (tracks != null)
				msgs = ((InternalEObject) tracks).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__TRACKS, null, msgs);
			if (newTracks != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__TRACKS, newTracks,
					newTracks));
	}
	...
	public NotificationChain basicSetActuators(ControlSurfaceActuatorsType newActuators, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.SPOILER_TYPE__ACTUATORS, oldActuators, newActuators);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newActuators != actuators) {
			...
			if (actuators != null)
				msgs = ((InternalEObject) actuators).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.SPOILER_TYPE__ACTUATORS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__ACTUATORS, newActuators,
					newActuators));
	}
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.SPOILER_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.SPOILER_TYPE__NAME:
			return basicSetName(null, msgs);
		case CpacsPackage.SPOILER_TYPE__DESCRIPTION:
			return basicSetDescription(null, msgs);
		case CpacsPackage.SPOILER_TYPE__PARENT_UID:
			return basicSetParentUID(null, msgs);
		case CpacsPackage.SPOILER_TYPE__OUTER_SHAPE:
			return basicSetOuterShape(null, msgs);
		case CpacsPackage.SPOILER_TYPE__WING_CUT_OUT:
			return basicSetWingCutOut(null, msgs);
		case CpacsPackage.SPOILER_TYPE__STRUCTURE:
			return basicSetStructure(null, msgs);
		case CpacsPackage.SPOILER_TYPE__PATH:
			return basicSetPath(null, msgs);
		case CpacsPackage.SPOILER_TYPE__TRACKS:
			return basicSetTracks(null, msgs);
		case CpacsPackage.SPOILER_TYPE__ACTUATORS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.SPOILER_TYPE__ACTUATORS:
			return getActuators();
		case CpacsPackage.SPOILER_TYPE__UID:
			return getUID();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CpacsPackage.SPOILER_TYPE__PARENT_UID:
			...
			return;
		case CpacsPackage.SPOILER_TYPE__OUTER_SHAPE:
			setOuterShape((ControlSurfaceOuterShapeSpoilerType) newValue);
			return;
		case CpacsPackage.SPOILER_TYPE__WING_CUT_OUT:
	...
	public void eUnset(int featureID) {
		...
		case CpacsPackage.SPOILER_TYPE__PARENT_UID:
			...
			return;
		case CpacsPackage.SPOILER_TYPE__OUTER_SHAPE:
			setOuterShape((ControlSurfaceOuterShapeSpoilerType) null);
			return;
		case CpacsPackage.SPOILER_TYPE__WING_CUT_OUT:
