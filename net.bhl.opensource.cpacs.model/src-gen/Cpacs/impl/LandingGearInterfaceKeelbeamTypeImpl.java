...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Landing Gear Interface Keelbeam Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getSheetElementUID <em>Sheet Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getKeelWidthStringerUID <em>Keel Width Stringer UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getKeelHeightStringerUID <em>Keel Height Stringer UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getHFwdConLengthFrameUID <em>HFwd Con Length Frame UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getHFwdConHeightStringerUID <em>HFwd Con Height Stringer UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getHRearConLengthFrameUID <em>HRear Con Length Frame UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getHRearConHeightStringerUID <em>HRear Con Height Stringer UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getVFwdConLengthFrameUID <em>VFwd Con Length Frame UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getVRearConLengthFrameUID <em>VRear Con Length Frame UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getHFwdReinfocementElementUID <em>HFwd Reinfocement Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getHRearReinfocementElementUID <em>HRear Reinfocement Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getVFwdReinfocementElementUID <em>VFwd Reinfocement Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getVRearReinfocementElementUID <em>VRear Reinfocement Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.LandingGearInterfaceKeelbeamTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LandingGearInterfaceKeelbeamTypeImpl extends ComplexBaseTypeImpl
		implements LandingGearInterfaceKeelbeamType {
	/**
	 ...
	 * @generated
	 */
	protected LandingGearInterfaceKeelbeamTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getLandingGearInterfaceKeelbeamType();
	}
	...
	public NotificationChain basicSetSheetElementUID(StringUIDBaseType newSheetElementUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__SHEET_ELEMENT_UID, oldSheetElementUID,
					newSheetElementUID);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSheetElementUID != sheetElementUID) {
			...
			if (sheetElementUID != null)
				msgs = ((InternalEObject) sheetElementUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__SHEET_ELEMENT_UID,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__SHEET_ELEMENT_UID, newSheetElementUID,
					newSheetElementUID));
	}
	...
	public NotificationChain basicSetKeelWidthStringerUID(StringUIDBaseType newKeelWidthStringerUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_WIDTH_STRINGER_UID, oldKeelWidthStringerUID,
	...
	public void setKeelWidthStringerUID(StringUIDBaseType newKeelWidthStringerUID) {
		if (newKeelWidthStringerUID != keelWidthStringerUID) {
			...
			if (keelWidthStringerUID != null)
				msgs = ((InternalEObject) keelWidthStringerUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_WIDTH_STRINGER_UID,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_WIDTH_STRINGER_UID, newKeelWidthStringerUID,
					newKeelWidthStringerUID));
	}
	...
	public NotificationChain basicSetKeelHeightStringerUID(StringUIDBaseType newKeelHeightStringerUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_HEIGHT_STRINGER_UID,
					oldKeelHeightStringerUID, newKeelHeightStringerUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setKeelHeightStringerUID(StringUIDBaseType newKeelHeightStringerUID) {
		if (newKeelHeightStringerUID != keelHeightStringerUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_HEIGHT_STRINGER_UID,
					newKeelHeightStringerUID, newKeelHeightStringerUID));
	}
	...
	public NotificationChain basicSetHFwdConLengthFrameUID(StringUIDBaseType newHFwdConLengthFrameUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_LENGTH_FRAME_UID,
					oldHFwdConLengthFrameUID, newHFwdConLengthFrameUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setHFwdConLengthFrameUID(StringUIDBaseType newHFwdConLengthFrameUID) {
		if (newHFwdConLengthFrameUID != hFwdConLengthFrameUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_LENGTH_FRAME_UID,
					newHFwdConLengthFrameUID, newHFwdConLengthFrameUID));
	}
	...
	public NotificationChain basicSetHFwdConHeightStringerUID(StringUIDBaseType newHFwdConHeightStringerUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_HEIGHT_STRINGER_UID,
	...
	public void setHFwdConHeightStringerUID(StringUIDBaseType newHFwdConHeightStringerUID) {
		if (newHFwdConHeightStringerUID != hFwdConHeightStringerUID) {
			...
			if (hFwdConHeightStringerUID != null)
				msgs = ((InternalEObject) hFwdConHeightStringerUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_HEIGHT_STRINGER_UID,
						null, msgs);
			if (newHFwdConHeightStringerUID != null)
				msgs = ((InternalEObject) newHFwdConHeightStringerUID).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_HEIGHT_STRINGER_UID,
						null, msgs);
	...
	public NotificationChain basicSetHRearConLengthFrameUID(StringUIDBaseType newHRearConLengthFrameUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_CON_LENGTH_FRAME_UID,
					oldHRearConLengthFrameUID, newHRearConLengthFrameUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setHRearConLengthFrameUID(StringUIDBaseType newHRearConLengthFrameUID) {
		if (newHRearConLengthFrameUID != hRearConLengthFrameUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_CON_LENGTH_FRAME_UID,
					newHRearConLengthFrameUID, newHRearConLengthFrameUID));
	}
	...
	public NotificationChain basicSetHRearConHeightStringerUID(StringUIDBaseType newHRearConHeightStringerUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_CON_HEIGHT_STRINGER_UID,
	...
	public NotificationChain basicSetVFwdConLengthFrameUID(StringUIDBaseType newVFwdConLengthFrameUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VFWD_CON_LENGTH_FRAME_UID,
					oldVFwdConLengthFrameUID, newVFwdConLengthFrameUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setVFwdConLengthFrameUID(StringUIDBaseType newVFwdConLengthFrameUID) {
		if (newVFwdConLengthFrameUID != vFwdConLengthFrameUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VFWD_CON_LENGTH_FRAME_UID,
					newVFwdConLengthFrameUID, newVFwdConLengthFrameUID));
	}
	...
	public NotificationChain basicSetVRearConLengthFrameUID(StringUIDBaseType newVRearConLengthFrameUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VREAR_CON_LENGTH_FRAME_UID,
					oldVRearConLengthFrameUID, newVRearConLengthFrameUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setVRearConLengthFrameUID(StringUIDBaseType newVRearConLengthFrameUID) {
		if (newVRearConLengthFrameUID != vRearConLengthFrameUID) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VREAR_CON_LENGTH_FRAME_UID,
					newVRearConLengthFrameUID, newVRearConLengthFrameUID));
	}
	...
	public NotificationChain basicSetHFwdReinfocementElementUID(StringUIDBaseType newHFwdReinfocementElementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_REINFOCEMENT_ELEMENT_UID,
	...
	public NotificationChain basicSetHRearReinfocementElementUID(StringUIDBaseType newHRearReinfocementElementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_REINFOCEMENT_ELEMENT_UID,
	...
	public NotificationChain basicSetVFwdReinfocementElementUID(StringUIDBaseType newVFwdReinfocementElementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VFWD_REINFOCEMENT_ELEMENT_UID,
	...
	public NotificationChain basicSetVRearReinfocementElementUID(StringUIDBaseType newVRearReinfocementElementUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VREAR_REINFOCEMENT_ELEMENT_UID,
	...
	public void setUID(String newUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__SHEET_ELEMENT_UID:
			return basicSetSheetElementUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_WIDTH_STRINGER_UID:
			return basicSetKeelWidthStringerUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__KEEL_HEIGHT_STRINGER_UID:
			return basicSetKeelHeightStringerUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_LENGTH_FRAME_UID:
			return basicSetHFwdConLengthFrameUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_CON_HEIGHT_STRINGER_UID:
			return basicSetHFwdConHeightStringerUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_CON_LENGTH_FRAME_UID:
			return basicSetHRearConLengthFrameUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_CON_HEIGHT_STRINGER_UID:
			return basicSetHRearConHeightStringerUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VFWD_CON_LENGTH_FRAME_UID:
			return basicSetVFwdConLengthFrameUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VREAR_CON_LENGTH_FRAME_UID:
			return basicSetVRearConLengthFrameUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HFWD_REINFOCEMENT_ELEMENT_UID:
			return basicSetHFwdReinfocementElementUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__HREAR_REINFOCEMENT_ELEMENT_UID:
			return basicSetHRearReinfocementElementUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VFWD_REINFOCEMENT_ELEMENT_UID:
			return basicSetVFwdReinfocementElementUID(null, msgs);
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__VREAR_REINFOCEMENT_ELEMENT_UID:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.LANDING_GEAR_INTERFACE_KEELBEAM_TYPE__UID:
			return getUID();
		}
...
} //LandingGearInterfaceKeelbeamTypeImpl
