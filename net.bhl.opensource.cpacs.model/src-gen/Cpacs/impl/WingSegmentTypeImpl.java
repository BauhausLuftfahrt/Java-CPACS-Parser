...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Wing Segment Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.WingSegmentTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentTypeImpl#getFromElementUID <em>From Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentTypeImpl#getToElementUID <em>To Element UID</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentTypeImpl#getGuideCurves <em>Guide Curves</em>}</li>
 *   <li>{@link Cpacs.impl.WingSegmentTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WingSegmentTypeImpl extends ComplexBaseTypeImpl implements WingSegmentType {
	/**
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getWingSegmentType();
	}
	...
	public NotificationChain basicSetName(StringBaseType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_TYPE__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_TYPE__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.WING_SEGMENT_TYPE__NAME, newName,
					newName));
	}
	...
	public NotificationChain basicSetDescription(StringBaseType newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_TYPE__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject) description).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_TYPE__DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.WING_SEGMENT_TYPE__DESCRIPTION,
	...
	public NotificationChain basicSetFromElementUID(StringUIDBaseType newFromElementUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_TYPE__FROM_ELEMENT_UID, oldFromElementUID, newFromElementUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newFromElementUID != fromElementUID) {
			...
			if (fromElementUID != null)
				msgs = ((InternalEObject) fromElementUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_TYPE__FROM_ELEMENT_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.WING_SEGMENT_TYPE__FROM_ELEMENT_UID,
	...
	public NotificationChain basicSetToElementUID(StringUIDBaseType newToElementUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_TYPE__TO_ELEMENT_UID, oldToElementUID, newToElementUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newToElementUID != toElementUID) {
			...
			if (toElementUID != null)
				msgs = ((InternalEObject) toElementUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_TYPE__TO_ELEMENT_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.WING_SEGMENT_TYPE__TO_ELEMENT_UID,
	...
	public NotificationChain basicSetGuideCurves(GuideCurvesType newGuideCurves, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.WING_SEGMENT_TYPE__GUIDE_CURVES, oldGuideCurves, newGuideCurves);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newGuideCurves != guideCurves) {
			...
			if (guideCurves != null)
				msgs = ((InternalEObject) guideCurves).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.WING_SEGMENT_TYPE__GUIDE_CURVES, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.WING_SEGMENT_TYPE__GUIDE_CURVES,
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.WING_SEGMENT_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.WING_SEGMENT_TYPE__NAME:
			return basicSetName(null, msgs);
		case CpacsPackage.WING_SEGMENT_TYPE__DESCRIPTION:
			return basicSetDescription(null, msgs);
		case CpacsPackage.WING_SEGMENT_TYPE__FROM_ELEMENT_UID:
			return basicSetFromElementUID(null, msgs);
		case CpacsPackage.WING_SEGMENT_TYPE__TO_ELEMENT_UID:
			return basicSetToElementUID(null, msgs);
		case CpacsPackage.WING_SEGMENT_TYPE__GUIDE_CURVES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.WING_SEGMENT_TYPE__UID:
			return getUID();
		}
