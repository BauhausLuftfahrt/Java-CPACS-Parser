...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pylon Shackle Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.PylonShackleTypeImpl#getMaterial <em>Material</em>}</li>
 *   <li>{@link Cpacs.impl.PylonShackleTypeImpl#getStructuralProfileUID <em>Structural Profile UID</em>}</li>
 *   <li>{@link Cpacs.impl.PylonShackleTypeImpl#getUID <em>UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PylonShackleTypeImpl extends ComplexBaseTypeImpl implements PylonShackleType {
	/**
	 ...
	 * @generated
	 */
	protected PylonShackleTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getPylonShackleType();
	}
	...
	public NotificationChain basicSetMaterial(MaterialDefinitionType newMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.PYLON_SHACKLE_TYPE__MATERIAL, oldMaterial, newMaterial);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMaterial != material) {
			...
			if (material != null)
				msgs = ((InternalEObject) material).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.PYLON_SHACKLE_TYPE__MATERIAL, null, msgs);
			if (newMaterial != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.PYLON_SHACKLE_TYPE__MATERIAL,
	...
	public NotificationChain basicSetStructuralProfileUID(StringUIDBaseType newStructuralProfileUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.PYLON_SHACKLE_TYPE__STRUCTURAL_PROFILE_UID, oldStructuralProfileUID,
		...
		if (newStructuralProfileUID != structuralProfileUID) {
			...
			if (structuralProfileUID != null)
				msgs = ((InternalEObject) structuralProfileUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.PYLON_SHACKLE_TYPE__STRUCTURAL_PROFILE_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.PYLON_SHACKLE_TYPE__STRUCTURAL_PROFILE_UID, newStructuralProfileUID,
					newStructuralProfileUID));
	}
	...
	public void setUID(String newUID) {
		...
		uID = newUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.PYLON_SHACKLE_TYPE__UID, oldUID, uID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.PYLON_SHACKLE_TYPE__MATERIAL:
			return basicSetMaterial(null, msgs);
		case CpacsPackage.PYLON_SHACKLE_TYPE__STRUCTURAL_PROFILE_UID:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CpacsPackage.PYLON_SHACKLE_TYPE__UID:
			return getUID();
		}
