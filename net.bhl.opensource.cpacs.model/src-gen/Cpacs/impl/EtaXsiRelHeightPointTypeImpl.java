...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Eta Xsi Rel Height Point Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.EtaXsiRelHeightPointTypeImpl#getEta <em>Eta</em>}</li>
 *   <li>{@link Cpacs.impl.EtaXsiRelHeightPointTypeImpl#getXsi <em>Xsi</em>}</li>
 *   <li>{@link Cpacs.impl.EtaXsiRelHeightPointTypeImpl#getRelHeight <em>Rel Height</em>}</li>
 *   <li>{@link Cpacs.impl.EtaXsiRelHeightPointTypeImpl#getReferenceUID <em>Reference UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EtaXsiRelHeightPointTypeImpl extends ComplexBaseTypeImpl implements EtaXsiRelHeightPointType {
	/**
	 ...
	 * @generated
	 */
	protected EtaXsiRelHeightPointTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getEtaXsiRelHeightPointType();
	}
	...
	public NotificationChain basicSetEta(DoubleBaseType newEta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__ETA, oldEta, newEta);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEta != eta) {
			...
			if (eta != null)
				msgs = ((InternalEObject) eta).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__ETA, null, msgs);
			if (newEta != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__ETA,
					newEta, newEta));
	}
	...
	public NotificationChain basicSetXsi(DoubleBaseType newXsi, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__XSI, oldXsi, newXsi);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newXsi != xsi) {
			...
			if (xsi != null)
				msgs = ((InternalEObject) xsi).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__XSI, null, msgs);
			if (newXsi != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__XSI,
					newXsi, newXsi));
	}
	...
	public NotificationChain basicSetRelHeight(DoubleBaseType newRelHeight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REL_HEIGHT, oldRelHeight, newRelHeight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRelHeight != relHeight) {
			...
			if (relHeight != null)
				msgs = ((InternalEObject) relHeight).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REL_HEIGHT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REL_HEIGHT, newRelHeight, newRelHeight));
	}
	...
	public NotificationChain basicSetReferenceUID(StringUIDBaseType newReferenceUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REFERENCE_UID, oldReferenceUID, newReferenceUID);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newReferenceUID != referenceUID) {
			...
			if (referenceUID != null)
				msgs = ((InternalEObject) referenceUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REFERENCE_UID, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REFERENCE_UID, newReferenceUID, newReferenceUID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__ETA:
			return basicSetEta(null, msgs);
		case CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__XSI:
			return basicSetXsi(null, msgs);
		case CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REL_HEIGHT:
			return basicSetRelHeight(null, msgs);
		case CpacsPackage.ETA_XSI_REL_HEIGHT_POINT_TYPE__REFERENCE_UID:
