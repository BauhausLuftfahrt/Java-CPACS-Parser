...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Flight Envelope Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.FlightEnvelopeTypeImpl#getAtmosphericModel <em>Atmospheric Model</em>}</li>
 *   <li>{@link Cpacs.impl.FlightEnvelopeTypeImpl#getDeltaTemperature <em>Delta Temperature</em>}</li>
 *   <li>{@link Cpacs.impl.FlightEnvelopeTypeImpl#getSpeed <em>Speed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlightEnvelopeTypeImpl extends ComplexBaseTypeImpl implements FlightEnvelopeType {
	/**
	 ...
	 * @ordered
	 */
	protected EList<FlightEnvelopeSpeedType> speed;
	 ...
	 * @generated
	 */
	protected FlightEnvelopeTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getFlightEnvelopeType();
	}
	...
	public NotificationChain basicSetAtmosphericModel(AtmosphericModelType1 newAtmosphericModel,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_ENVELOPE_TYPE__ATMOSPHERIC_MODEL, oldAtmosphericModel, newAtmosphericModel);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAtmosphericModel != atmosphericModel) {
			...
			if (atmosphericModel != null)
				msgs = ((InternalEObject) atmosphericModel).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_ENVELOPE_TYPE__ATMOSPHERIC_MODEL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_ENVELOPE_TYPE__ATMOSPHERIC_MODEL,
	...
	public NotificationChain basicSetDeltaTemperature(DoubleBaseType newDeltaTemperature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.FLIGHT_ENVELOPE_TYPE__DELTA_TEMPERATURE, oldDeltaTemperature, newDeltaTemperature);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDeltaTemperature != deltaTemperature) {
			...
			if (deltaTemperature != null)
				msgs = ((InternalEObject) deltaTemperature).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.FLIGHT_ENVELOPE_TYPE__DELTA_TEMPERATURE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.FLIGHT_ENVELOPE_TYPE__DELTA_TEMPERATURE,
	 ...
	 */
	@Override
	public EList<FlightEnvelopeSpeedType> getSpeed() {
		if (speed == null) {
			speed = new EObjectContainmentEList<FlightEnvelopeSpeedType>(FlightEnvelopeSpeedType.class, this,
					CpacsPackage.FLIGHT_ENVELOPE_TYPE__SPEED);
		}
		return speed;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.FLIGHT_ENVELOPE_TYPE__ATMOSPHERIC_MODEL:
			return basicSetAtmosphericModel(null, msgs);
		case CpacsPackage.FLIGHT_ENVELOPE_TYPE__DELTA_TEMPERATURE:
			return basicSetDeltaTemperature(null, msgs);
		case CpacsPackage.FLIGHT_ENVELOPE_TYPE__SPEED:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CpacsPackage.FLIGHT_ENVELOPE_TYPE__SPEED:
			getSpeed().clear();
			getSpeed().addAll((Collection<? extends FlightEnvelopeSpeedType>) newValue);
			return;
		}
