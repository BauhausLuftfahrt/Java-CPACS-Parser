...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Aircraft Control Element Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.AircraftControlElementTypeImpl#getControlDeviceUID <em>Control Device UID</em>}</li>
 *   <li>{@link Cpacs.impl.AircraftControlElementTypeImpl#getControlParameter <em>Control Parameter</em>}</li>
 *   <li>{@link Cpacs.impl.AircraftControlElementTypeImpl#getControlDistributorUID <em>Control Distributor UID</em>}</li>
 *   <li>{@link Cpacs.impl.AircraftControlElementTypeImpl#getCommandInput <em>Command Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AircraftControlElementTypeImpl extends ComplexBaseTypeImpl implements AircraftControlElementType {
	/**
	 ...
	 * @generated
	 */
	protected AircraftControlElementTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getAircraftControlElementType();
	}
	...
	public NotificationChain basicSetControlDeviceUID(StringUIDBaseType newControlDeviceUID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DEVICE_UID, oldControlDeviceUID,
					newControlDeviceUID);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newControlDeviceUID != controlDeviceUID) {
			...
			if (controlDeviceUID != null)
				msgs = ((InternalEObject) controlDeviceUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DEVICE_UID, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DEVICE_UID, newControlDeviceUID,
					newControlDeviceUID));
	}
	...
	public NotificationChain basicSetControlParameter(DoubleBaseType newControlParameter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_PARAMETER, oldControlParameter,
					newControlParameter);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newControlParameter != controlParameter) {
			...
			if (controlParameter != null)
				msgs = ((InternalEObject) controlParameter).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_PARAMETER, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_PARAMETER, newControlParameter,
					newControlParameter));
	}
	...
	public NotificationChain basicSetControlDistributorUID(StringUIDBaseType newControlDistributorUID,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DISTRIBUTOR_UID, oldControlDistributorUID,
		...
		if (newControlDistributorUID != controlDistributorUID) {
			...
			if (controlDistributorUID != null)
				msgs = ((InternalEObject) controlDistributorUID).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DISTRIBUTOR_UID,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DISTRIBUTOR_UID, newControlDistributorUID,
					newControlDistributorUID));
	}
	...
	public NotificationChain basicSetCommandInput(DoubleBaseType newCommandInput, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__COMMAND_INPUT, oldCommandInput, newCommandInput);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newCommandInput != commandInput) {
			...
			if (commandInput != null)
				msgs = ((InternalEObject) commandInput).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__COMMAND_INPUT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__COMMAND_INPUT, newCommandInput, newCommandInput));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DEVICE_UID:
			return basicSetControlDeviceUID(null, msgs);
		case CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_PARAMETER:
			return basicSetControlParameter(null, msgs);
		case CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__CONTROL_DISTRIBUTOR_UID:
			return basicSetControlDistributorUID(null, msgs);
		case CpacsPackage.AIRCRAFT_CONTROL_ELEMENT_TYPE__COMMAND_INPUT:
...
} //AircraftControlElementTypeImpl
