...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Actuator Control Surface Attachment Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.ActuatorControlSurfaceAttachmentTypeImpl#getParentXsi <em>Parent Xsi</em>}</li>
 *   <li>{@link Cpacs.impl.ActuatorControlSurfaceAttachmentTypeImpl#getParentHeight <em>Parent Height</em>}</li>
 *   <li>{@link Cpacs.impl.ActuatorControlSurfaceAttachmentTypeImpl#getMaterial <em>Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActuatorControlSurfaceAttachmentTypeImpl extends ComplexBaseTypeImpl
		implements ActuatorControlSurfaceAttachmentType {
	/**
	 ...
	 * @generated
	 */
	protected ActuatorControlSurfaceAttachmentTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getActuatorControlSurfaceAttachmentType();
	}
	...
	public NotificationChain basicSetParentXsi(DoubleBaseType newParentXsi, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_XSI, oldParentXsi, newParentXsi);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newParentXsi != parentXsi) {
			...
			if (parentXsi != null)
				msgs = ((InternalEObject) parentXsi).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_XSI,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_XSI, newParentXsi, newParentXsi));
	}
	...
	public NotificationChain basicSetParentHeight(DoubleBaseType newParentHeight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_HEIGHT, oldParentHeight,
					newParentHeight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newParentHeight != parentHeight) {
			...
			if (parentHeight != null)
				msgs = ((InternalEObject) parentHeight).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_HEIGHT,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_HEIGHT, newParentHeight,
					newParentHeight));
	}
	...
	public NotificationChain basicSetMaterial(MaterialDefinitionType newMaterial, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__MATERIAL, oldMaterial, newMaterial);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMaterial != material) {
			...
			if (material != null)
				msgs = ((InternalEObject) material).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__MATERIAL, null,
						msgs);
			if (newMaterial != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__MATERIAL, newMaterial, newMaterial));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_XSI:
			return basicSetParentXsi(null, msgs);
		case CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__PARENT_HEIGHT:
			return basicSetParentHeight(null, msgs);
		case CpacsPackage.ACTUATOR_CONTROL_SURFACE_ATTACHMENT_TYPE__MATERIAL:
...
} //ActuatorControlSurfaceAttachmentTypeImpl
