...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Double Vector Constraint Base Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.DoubleVectorConstraintBaseTypeImpl#getRelationalOperator <em>Relational Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleVectorConstraintBaseTypeImpl extends DoubleVectorBaseTypeImpl
		implements DoubleVectorConstraintBaseType {
	/**
	 ...
	 * @generated
	 */
	protected DoubleVectorConstraintBaseTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getDoubleVectorConstraintBaseType();
	}
	...
	public void setRelationalOperator(RelationalOperatorType newRelationalOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.DOUBLE_VECTOR_CONSTRAINT_BASE_TYPE__RELATIONAL_OPERATOR, oldRelationalOperator,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.DOUBLE_VECTOR_CONSTRAINT_BASE_TYPE__RELATIONAL_OPERATOR:
...
} //DoubleVectorConstraintBaseTypeImpl
