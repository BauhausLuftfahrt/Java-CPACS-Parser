...
import Cpacs.UncertaintyFunctionType;
 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getA <em>A</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getB <em>B</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getC <em>C</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getDelta <em>Delta</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getMu <em>Mu</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getUncertaintyFunctionName <em>Uncertainty Function Name</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getV <em>V</em>}</li>
 *   <li>{@link Cpacs.impl.DoubleBaseTypeImpl#getW <em>W</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleBaseTypeImpl extends MinimalEObjectImpl.Container implements DoubleBaseType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getDoubleBaseType();
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__VALUE, oldValue, value,
					!oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__VALUE, oldValue,
	...
	public void setA(double newA) {
		...
		aESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__A, oldA, a,
					!oldAESet));
	}
	...
	public void unsetA() {
		...
		aESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__A, oldA, A_EDEFAULT,
					oldAESet));
	}
	...
	public void setB(double newB) {
		...
		bESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__B, oldB, b,
					!oldBESet));
	}
	...
	public void unsetB() {
		...
		bESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__B, oldB, B_EDEFAULT,
					oldBESet));
	}
	...
	public void setC(double newC) {
		...
		cESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__C, oldC, c,
					!oldCESet));
	}
	...
	public void unsetC() {
		...
		cESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__C, oldC, C_EDEFAULT,
					oldCESet));
	}
	...
	public void setDelta(double newDelta) {
		...
		deltaESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__DELTA, oldDelta, delta,
					!oldDeltaESet));
	}
	...
	public void unsetDelta() {
		...
		deltaESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__DELTA, oldDelta,
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.DOUBLE_BASE_TYPE__EXTERNAL_DATA_DIRECTORY, oldExternalDataDirectory,
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.DOUBLE_BASE_TYPE__EXTERNAL_DATA_NODE_PATH, oldExternalDataNodePath,
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__EXTERNAL_FILE_NAME,
	...
	public void setMu(double newMu) {
		...
		muESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__MU, oldMu, mu,
					!oldMuESet));
	}
	...
	public void unsetMu() {
		...
		muESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__MU, oldMu,
	...
	public void setUncertaintyFunctionName(UncertaintyFunctionType newUncertaintyFunctionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CpacsPackage.DOUBLE_BASE_TYPE__UNCERTAINTY_FUNCTION_NAME, oldUncertaintyFunctionName,
	...
	public void setV(double newV) {
		...
		vESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__V, oldV, v,
					!oldVESet));
	}
	...
	public void unsetV() {
		...
		vESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__V, oldV, V_EDEFAULT,
					oldVESet));
	}
	...
	public void setW(double newW) {
		...
		wESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.DOUBLE_BASE_TYPE__W, oldW, w,
					!oldWESet));
	}
	...
	public void unsetW() {
		...
		wESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.DOUBLE_BASE_TYPE__W, oldW, W_EDEFAULT,
					oldWESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.DOUBLE_BASE_TYPE__VALUE:
			return getValue();
		case CpacsPackage.DOUBLE_BASE_TYPE__A:
			return getA();
		case CpacsPackage.DOUBLE_BASE_TYPE__B:
			return getB();
		case CpacsPackage.DOUBLE_BASE_TYPE__C:
			return getC();
		case CpacsPackage.DOUBLE_BASE_TYPE__DELTA:
			return getDelta();
		case CpacsPackage.DOUBLE_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case CpacsPackage.DOUBLE_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case CpacsPackage.DOUBLE_BASE_TYPE__EXTERNAL_FILE_NAME:
			return getExternalFileName();
		case CpacsPackage.DOUBLE_BASE_TYPE__MU:
			return getMu();
		case CpacsPackage.DOUBLE_BASE_TYPE__UNCERTAINTY_FUNCTION_NAME:
			return getUncertaintyFunctionName();
		case CpacsPackage.DOUBLE_BASE_TYPE__V:
			return getV();
		case CpacsPackage.DOUBLE_BASE_TYPE__W:
			return getW();
		}
