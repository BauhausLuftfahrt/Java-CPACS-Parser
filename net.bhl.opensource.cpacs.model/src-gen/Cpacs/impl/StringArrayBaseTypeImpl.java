 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.impl.StringArrayBaseTypeImpl#getMapType <em>Map Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringArrayBaseTypeImpl extends StringBaseTypeImpl implements StringArrayBaseType {
	...
	protected EClass eStaticClass() {
		return CpacsPackage.eINSTANCE.getStringArrayBaseType();
	}
	...
	public void setMapType(String newMapType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpacsPackage.STRING_ARRAY_BASE_TYPE__MAP_TYPE,
	...
	public void unsetMapType() {
		...
		mapTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CpacsPackage.STRING_ARRAY_BASE_TYPE__MAP_TYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpacsPackage.STRING_ARRAY_BASE_TYPE__MAP_TYPE:
			return getMapType();
		}
