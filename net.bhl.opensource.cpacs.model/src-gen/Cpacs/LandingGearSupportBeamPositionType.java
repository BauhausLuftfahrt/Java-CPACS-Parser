...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Landing Gear Support Beam Position Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link Cpacs.LandingGearSupportBeamPositionType#getXsiInside <em>Xsi Inside</em>}</li>
 *   <li>{@link Cpacs.LandingGearSupportBeamPositionType#getEtaOutside <em>Eta Outside</em>}</li>
 * </ul>
 *
 * @see Cpacs.CpacsPackage#getLandingGearSupportBeamPositionType()
 * @model extendedMetaData="name='landingGearSupportBeamPositionType' kind='elementOnly'"
 * @generated
 */
public interface LandingGearSupportBeamPositionType extends ComplexBaseType {
	/**
	 ...
	 * @see Cpacs.CpacsPackage#getLandingGearSupportBeamPositionType_XsiInside()
	...
	/**
	 * Sets the value of the '{@link Cpacs.LandingGearSupportBeamPositionType#getXsiInside <em>Xsi Inside</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Cpacs.CpacsPackage#getLandingGearSupportBeamPositionType_EtaOutside()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link Cpacs.LandingGearSupportBeamPositionType#getEtaOutside <em>Eta Outside</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
...
} // LandingGearSupportBeamPositionType
