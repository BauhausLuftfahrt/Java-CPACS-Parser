 ...
 * <!-- end-user-doc -->
 * @see Cpacs.CpacsPackage#getRefTypeType()
 * @model extendedMetaData="name='refType_._type'"
 * @generated
 */
public enum RefTypeType implements Enumerator {
	 ...
	 * @ordered
	 */
	ABS_GLOBAL(0, "absGlobal", "absGlobal"),
	 ...
	 * @ordered
	 */
	public static final int ABS_GLOBAL_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int ABS_LOCAL_VALUE = 1;
	 ...
	 * @generated
	 */
	private static final RefTypeType[] VALUES_ARRAY = new RefTypeType[] { ABS_GLOBAL, ABS_LOCAL, };
	...
	public static RefTypeType get(int value) {
		switch (value) {
		case ABS_GLOBAL_VALUE:
			return ABS_GLOBAL;
		case ABS_LOCAL_VALUE:
			return ABS_LOCAL;
		}
		return null;
	}
